...
Public Class frmAddPropertyOption
    ...
    Private Sub LoadGrid()
        Dim ds As DataSet ' OSAEObjectType.GetObjectTypePropertyOptions(iObjectType, iProperty)
    ...
    Private Sub btnAddPropOption_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddPropOption.Click
        OSAEObjectTypeManager.ObjectTypePropertyOptionAdd(iObjectType, iProperty, txbxPropOption.Text)
        LoadGrid()
    End Sub
    ...
    Private Sub btnUpdatePropOption_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdatePropOption.Click
        OSAEObjectTypeManager.ObjectTypePropertyOptionUpdate(iObjectType, iProperty, txbxPropOption.Text, dgvPropertyOptions("Column1", dgvPropertyOptions.CurrentCell.RowIndex).Value)
        LoadGrid()
    End Sub
    ...
    Private Sub btnDeletePropOption_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDeletePropOption.Click
        OSAEObjectTypeManager.ObjectTypePropertyOptionDelete(iObjectType, iProperty, dgvPropertyOptions("Column1", dgvPropertyOptions.CurrentCell.RowIndex).Value)
        LoadGrid()
    End Sub
End Class