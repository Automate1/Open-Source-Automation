...
Public Class frmObjects
    ...
    Private Sub dgvProperties_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvProperties.CurrentCellChanged
        Try
            ...
            Dim list As DataSet ' = OSAEObjectTypeManager.GetObjectTypePropertyOptions(dgvObjects("object_type", dgvObjects.CurrentCell.RowIndex).Value, dgvProperties("property_name", dgvProperties.CurrentCell.RowIndex).Value)
            Dim listValues As DataSet = OSAEObjectPropertyManager.ObjectPropertyArrayGetAll(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value, dgvProperties("property_name", dgvProperties.CurrentCell.RowIndex).Value)
    ...
    Private Sub butObjectUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butObjectUpdate.Click
        OSAEObjectManager.ObjectUpdate(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value, txtObject.Text, txtObjectDescription.Text, cboObjectTypes.Text, txtAddress.Text, comLocation.Text, Math.Abs(CInt(chkEnabled.Checked)))
        Load_Objects()
        Load_Containers()
    End Sub
    ...
    Private Sub butObjectDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butObjectDelete.Click
        ...
        If result = Windows.Forms.DialogResult.Yes Then
            OSAEObjectManager.ObjectDelete(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value)
            Load_Objects()
            Load_Containers()
        End If
    End Sub
    ...
    Private Sub butPropertyUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butPropertyUpdate.Click
        ...
        OSAEObjectPropertyManager.ObjectPropertySet(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value, dgvProperties("property_name", dgvProperties.CurrentCell.RowIndex).Value, txtProperty.Text, "Config")
        Load_Object_Properties()
    End Sub
    ...
    Private Sub comObjectStates_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles comObjectStates.SelectedIndexChanged
        If flgLoadingStates = 0 Then
            ...
            Try
                OSAEObjectStateManager.ObjectStateSet(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value, comObjectStates.Text, "Config")
                Load_Objects()
            Catch myerror As MySqlException
    ...
    Private Sub butObjectAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butObjectAdd.Click
        OSAEObjectManager.ObjectAdd(txtObject.Text, txtObjectDescription.Text, cboObjectTypes.Text, txtAddress.Text, comLocation.Text, True)
        OSAEObjectStateManager.ObjectStateSet(txtObject.Text, "OFF", "Config")
        Load_Objects()
        Load_Containers()
    End Sub
    ...
    Private Sub butFile_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butFile.Click
        ...
        If res = DialogResult.OK Then
            txtProperty.Text = file1.FileName.Replace(Common.ApiPath, "")
        End If
    End Sub
    ...
    Private Sub Run_Method()
        OSAEMethodManager.MethodQueueAdd(dgvObjects("object_name", dgvObjects.CurrentCell.RowIndex).Value, comObjectMethods.Text, txtParamLabel1.Text, txtParamLabel2.Text, "Config")
        comObjectMethods.Text = ""
        txtParamLabel1.Text = ""
        txtParamLabel2.Text = ""
        Load_Objects()
