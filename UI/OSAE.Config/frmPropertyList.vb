...
Public Class frmPropertyList
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        OSAEObjectPropertyManager.ObjectPropertyArrayAdd(lblObject.Text, lblProperty.Text, txtValue.Text, txtLabel.Text)
        Load_Grid()
    End Sub
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        OSAEObjectPropertyManager.ObjectPropertyArrayDelete(lblObject.Text, lblProperty.Text, txtValue.Text)
        Load_Grid()
    End Sub
